...
kubectl set image deployments/worker-deployment server=jerrymajewski/multi-worker:$SHA
kubectl set image deployments/client-deployment server=jerrymajewski/multi-client:$SHA
